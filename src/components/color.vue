...
import {
  getAllLCWarehouseList,
  getAllSjWarehouseList,
...
function queryWarehouseList() {
  ...
  getAllSjWarehouseList(queryParams.value).then(({ data: {code, data, msg} }: any) => {
    if (code == 200) {
      console.log(data);
...
<template>
  <div class="container">
    ...
    >
      ...
      <vxe-column field="warehouseCode" min-width="160" title="工单号            "></vxe-column>
